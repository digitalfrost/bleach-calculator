...
var s = new BleachSolution({initialConcentration : 20, initialVolume: 10, finalVolume: 10});
   // s = new BleachSolution({initialConcentration : 114.94, initialVolume: 0.10957, finalVolume: 250});

console.log ("Test5 FC2:" + s.finalConcentration);
console.log("Test mC: " + s.initialDensity());
...
describe('initial density', function(){
  ...
  it('should throw exception if manufacturing concentration is not 24% or 13%', function(){
      solution = new BleachSolution({initialConcentration: 5.50, manufacturingConcentration: 19})
  ...
  it('should return initial density for 13% initial manufacturing concentration', function(){
      solution = new BleachSolution({initialConcentration: 9.6, manufacturingConcentration: 13})
    ...
    it('should return initial density for 24% initial manufacturing concentration', function(){
      solution = new BleachSolution({initialConcentration: 9.6, manufacturingConcentration: 24})
...
describe('active chlorine calculation', function(){
  it('should calculate active chlorine for an initial solution at 9.6% made from Sodium Hydrochloride with 13% acive chlorine', function(){
    ...
    it('should calculate active chlorine for an initial solution at 5.5% made from Sodium Hydrochloride with 13% acive chlorine', function(){
      solution = new BleachSolution({initialConcentration: 5.50, manufacturingConcentration: 13})
    ...
    it('should calculate active chlorine for an initial solution at 9.6% made from Sodium Hydrochloride with 24% acive chlorine', function(){
      solution = new BleachSolution({initialConcentration: 2.6})
    ...
    it('should calculate active chlorine for an initial solution at 5.5% made from Sodium Hydrochloride with 24% acive chlorine', function(){
      solution = new BleachSolution({initialConcentration: 9.10})
...
describe('Calculate Bleach Solution', function() {
  it('should calculate initial volume', function() {
    s = new BleachSolution({initialConcentration : 114.94, finalVolume: 10, finalConcentration: 1});
    s.initialVolume.should.equal(0.087);
  });

  it('should calculate initial concentration', function() {
    s = new BleachSolution({initialVolume : 0.02191, finalVolume: 100, finalConcentration: 0.025 });
    s.initialConcentration.should.equal(114.1);
  });

  it('should calculate initial concentration again', function() {
    s = new BleachSolution({initialVolume : 0.087, finalVolume: 10, finalConcentration: 1 });
    s.initialConcentration.should.equal(114.94);
  });

  it('should calculate final volume', function() {
    s = new BleachSolution({initialConcentration : 114.94, initialVolume: 0.04383, finalConcentration: 0.1});
